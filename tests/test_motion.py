...
check("§6 the v1.4.4 release added no key of its own (the pin has moved on with v1.4.5 and "
      "v1.4.6 — the pin in tests/_common.py is the shipped one)",
      EXPECTED_I18N_KEYS == 612
