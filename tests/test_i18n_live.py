...
check("the pin counts the keys of the SHIPPED release (v1.5.2 added THIRTEEN — all the CHROME "
      ...
      "their two ICMP evidence lines), v1.5.4 added ELEVEN: the group aggregate's two "
      ...
      "release cost no key, so 661 + 20 + 11 + 14 + 2 + 29 + 41 + 4 + 4 = 786)"
      " (v1.6.3 adds FOUR: the address bar's placeholder and its bad-path sentence and the "
      "cwd-follow switch with its tooltip),",
