...
# ─────────────────────────────────────────────────────────────────────────────
EXPECTED_APP_VERSION = "1.2.6"    # текущий релиз (sentinel: ловит «бамп не в ту версию»)
EXPECTED_I18N_KEYS = 422        # паритет en/ru/zh (v1.2.6: 421 + 1 — connection.bidirectional)
