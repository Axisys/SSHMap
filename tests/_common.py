...
# ─────────────────────────────────────────────────────────────────────────────
EXPECTED_APP_VERSION = "1.2.10"    # текущий релиз (sentinel: ловит «бамп не в ту версию»)
EXPECTED_I18N_KEYS = 427        # паритет en/ru/zh (v1.2.10: без новых ключей — 427 с v1.2.8)
