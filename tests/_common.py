...
# ─────────────────────────────────────────────────────────────────────────────
EXPECTED_APP_VERSION = "1.2.5"    # текущий релиз (sentinel: ловит «бамп не в ту версию»)
EXPECTED_I18N_KEYS = 421        # паритет en/ru/zh (v1.2.4.1: 417 + 3 — сворачивание панелей; +1 — запрет двойного сворачивания, v1.2.4.1-fix)
