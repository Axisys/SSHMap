...
check("the parity pin is the shipped one (the examples contribute nothing — the releases "
      "move the pin, not this file; v1.5.2 left it at 661)",
      EXPECTED_I18N_KEYS == 661 and all(len(translation_keys(d)) == EXPECTED_I18N_KEYS
...
check("the release is the version this file ships with (v1.5.2 is the second patch on 1.5)",
