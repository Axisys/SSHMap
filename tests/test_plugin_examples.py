...
check("the parity pin is the shipped one (the examples contribute nothing — the releases "
      "move the pin, not this file; v1.5 left it at 644)",
      EXPECTED_I18N_KEYS == 644 and all(len(translation_keys(d)) == EXPECTED_I18N_KEYS
...
check("the release is the version this file ships with (1.5 closed the 1.5 line)",
