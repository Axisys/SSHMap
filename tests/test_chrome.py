...
check("§4 the counts header is the LIVE table, not the registry",
      ...
      and _with == 23 and len(_counts) - _with == 31,
...
check("§8 the registry grew by the panel/map toggles and the v1.5.3 freshness pair",
      len(HR.action_ids()) == 54
      and HR.default_sequence("view.focus_map") == ""
      and len(HR.empty_default_action_ids()) == 31)
