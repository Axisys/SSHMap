# MANIFEST — the managed pyte fork (pyte 0.8.2 + patches 0001–0009, sshmap v1.5.7.1)
...
> (0004) and v1.5.7.1 (0005–0009 — the dependency audit of the raise-review section of
> PYTE82_AUDIT.md).
...
Rebasing onto a future upstream release: `git apply` (or `git am`) the nine patches onto the new
...
and the result is byte-for-byte the post-patch table.
...
| streams.py | 968454617e0c05aee25ddd554f17b56aef0e9290c7552698f6e4485e8c66b1ea |

The files untouched by the patches have the same hash in both tables; the files changed by
patches 0001–0009 are `screens.py` (0001–0005, 0007–0009) and `streams.py` (0006).
